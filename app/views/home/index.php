    ...
    <main class="g-pt-75 g-pt-90--md">
          ...
          <nav class="navbar navbar-expand-lg g-py-0">
            <div class="container g-pos-rel">
              ...
              <a href="#" class="navbar-brand u-header__logo">
                <img class="u-header__logo-img u-header__logo-img--main g-width-140" src="<?php echo STATIC_URL; ?>img/logo.png" alt="Image description">
              </a>
              <!-- End Logo -->
      ...
      <section id="home">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-6 u-bg-overlay g-flex-centered g-height-100vh--md g-min-height-300 g-bg-img-hero g-bg-black-opacity-0_7--after text-md-right g-py-40 g-pr-50--md" style="background-image: url(<?php echo STATIC_URL; ?>img-temp/700x800/img1.jpg);"
            ...
            <div class="col-md-6 u-bg-overlay g-flex-centered g-height-100vh--md g-min-height-300 g-bg-img-hero g-bg-black-opacity-0_7--after g-py-40 g-pl-50--md" style="background-image: url(<?php echo STATIC_URL; ?>img-temp/700x800/img2.jpg);"
                 data-calc-target="#js-header">
              <div class="w-100 u-bg-overlay__inner g-py-100">
                <h3 class="h4 g-font-weight-700 g-color-primary g-mb-20">We professionally do</h3>
          ...
          <div class="container text-center text-lg-left g-color-white">
            <div class="row">
              <div class="col-lg-3 ml-lg-auto">
                <img class="img-fluid g-width-200 g-width-auto--lg g-mb-30 g-mb-0--lg mx-auto" src="<?php echo STATIC_URL; ?>img-temp/874x600/img1.png" alt="Image description">
              </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-5 g-mb-30 g-mb-0--md">
              <img class="img-fluid g-mb-30" src="<?php echo STATIC_URL; ?>img-temp/1000x562/img1.jpg" alt="Image description">
      ...
      <section class="container-fluid px-0">
        <div class="row no-gutters">
          <div class="col-md-6">
            <div class="u-bg-overlay g-parent g-pos-rel g-min-height-300 g-bg-img-hero g-bg-black-opacity-0_6--after g-overflow-hidden" style="background-image: url(<?php echo STATIC_URL; ?>img-temp/900x506/img1.jpg);">
              <img class="img-fluid g-hidden-md-down g-transform-scale-1_2--parent-hover g-transition-0_2 g-transition--ease-in" src="<?php echo STATIC_URL; ?>img-temp/900x506/img1.jpg" alt="Image description">
          ...
          <div class="col-md-6">
            <div class="u-bg-overlay g-parent g-pos-rel g-min-height-300 g-bg-img-hero g-bg-black-opacity-0_6--after g-overflow-hidden" style="background-image: url(<?php echo STATIC_URL; ?>img-temp/900x506/img2.jpg);">
              <img class="img-fluid g-hidden-md-down g-transform-scale-1_2--parent-hover g-transition-0_2 g-transition--ease-in" src="<?php echo STATIC_URL; ?>img-temp/900x506/img2.jpg" alt="Image description">
        ...
        <div class="row no-gutters">
          <div class="col-md-6">
            <div class="u-bg-overlay g-parent g-pos-rel g-min-height-300 g-bg-img-hero g-bg-black-opacity-0_6--after g-overflow-hidden" style="background-image: url(<?php echo STATIC_URL; ?>img-temp/900x506/img3.jpg);">
              <img class="img-fluid g-hidden-md-down g-transform-scale-1_2--parent-hover g-transition-0_2 g-transition--ease-in" src="<?php echo STATIC_URL; ?>img-temp/900x506/img3.jpg" alt="Image description">
          ...
          <div class="col-md-6">
            <div class="u-bg-overlay g-parent g-pos-rel g-min-height-300 g-bg-img-hero g-bg-black-opacity-0_6--after g-overflow-hidden" style="background-image: url(<?php echo STATIC_URL; ?>img-temp/900x506/img4.jpg);">
              <img class="img-fluid g-hidden-md-down g-transform-scale-1_2--parent-hover g-transition-0_2 g-transition--ease-in" src="<?php echo STATIC_URL; ?>img-temp/900x506/img4.jpg" alt="Image description">
            ...
            <div class="col-md-8 col-lg-9">
              ...
              <div id="servicesTabs" class="tab-content">
                <div class="tab-pane fade g-pb-20 g-pb-0--md show active" id="servicesTabsBody1" role="tabpanel">
                  <div class="row">
                    <div class="col-md-6 col-lg-4 g-mb-20 g-mb-0--lg">
                      <img class="img-fluid g-mb-20" src="<?php echo STATIC_URL; ?>img-temp/600x397/img1.jpg" alt="Image description">
                    ...
                    <div class="col-md-6 col-lg-4 g-mb-20 g-mb-0--lg">
                      <img class="img-fluid g-mb-20" src="<?php echo STATIC_URL; ?>img-temp/600x397/img2.jpg" alt="Image description">
                    ...
                    <div class="col-md-6 col-lg-4">
                      <img class="img-fluid g-mb-20" src="<?php echo STATIC_URL; ?>img-temp/600x397/img3.jpg" alt="Image description">
                ...
                <div class="tab-pane fade g-pb-20 g-pb-0--md" id="servicesTabsBody2" role="tabpanel">
                  <div class="row">
                    <div class="col-md-6 col-lg-4 g-mb-20 g-mb-0--lg">
                      <img class="img-fluid g-mb-20" src="<?php echo STATIC_URL; ?>img-temp/600x397/img4.jpg" alt="Image description">
                    ...
                    <div class="col-md-6 col-lg-4 g-mb-20 g-mb-0--lg">
                      <img class="img-fluid g-mb-20" src="<?php echo STATIC_URL; ?>img-temp/600x397/img5.jpg" alt="Image description">
                    ...
                    <div class="col-md-6 col-lg-4">
                      <img class="img-fluid g-mb-20" src="<?php echo STATIC_URL; ?>img-temp/600x397/img6.jpg" alt="Image description">
                ...
                <div class="tab-pane fade g-pb-20 g-pb-0--md" id="servicesTabsBody3" role="tabpanel">
                  <div class="row">
                    <div class="col-md-6 col-lg-4 g-mb-20 g-mb-0--lg">
                      <img class="img-fluid g-mb-20" src="<?php echo STATIC_URL; ?>img-temp/600x397/img7.jpg" alt="Image description">
                    ...
                    <div class="col-md-6 col-lg-4 g-mb-20 g-mb-0--lg">
                      <img class="img-fluid g-mb-20" src="<?php echo STATIC_URL; ?>img-temp/600x397/img8.jpg" alt="Image description">
                    ...
                    <div class="col-md-6 col-lg-4">
                      <img class="img-fluid g-mb-20" src="<?php echo STATIC_URL; ?>img-temp/600x397/img9.jpg" alt="Image description">
                ...
                <div class="tab-pane fade g-pb-20 g-pb-0--md" id="servicesTabsBody4" role="tabpanel">
                  <div class="row">
                    <div class="col-md-6 col-lg-4 g-mb-20 g-mb-0--lg">
                      <img class="img-fluid g-mb-20" src="<?php echo STATIC_URL; ?>img-temp/600x397/img10.jpg" alt="Image description">
                    ...
                    <div class="col-md-6 col-lg-4 g-mb-20 g-mb-0--lg">
                      <img class="img-fluid g-mb-20" src="<?php echo STATIC_URL; ?>img-temp/600x397/img11.jpg" alt="Image description">
                    ...
                    <div class="col-md-6 col-lg-4">
                      <img class="img-fluid g-mb-20" src="<?php echo STATIC_URL; ?>img-temp/600x397/img12.jpg" alt="Image description">
                ...
                <div class="tab-pane fade" id="servicesTabsBody5" role="tabpanel">
                  <div class="row">
                    <div class="col-md-6 col-lg-4 g-mb-20 g-mb-0--lg">
                      <img class="img-fluid g-mb-20" src="<?php echo STATIC_URL; ?>img-temp/600x397/img13.jpg" alt="Image description">
                    ...
                    <div class="col-md-6 col-lg-4 g-mb-20 g-mb-0--lg">
                      <img class="img-fluid g-mb-20" src="<?php echo STATIC_URL; ?>img-temp/600x397/img14.jpg" alt="Image description">
                    ...
                    <div class="col-md-6 col-lg-4">
                      <img class="img-fluid g-mb-20" src="<?php echo STATIC_URL; ?>img-temp/600x397/img15.jpg" alt="Image description">
      ...
      <!-- Section Content -->
      <section id="recentProjects" class="u-bg-overlay g-bg-img-hero g-bg-primary-opacity-0_9--after g-py-100" style="background-image: url(<?php echo STATIC_URL; ?>img-temp/1920x1073/img1.jpg);">
        <div class="container u-bg-overlay__inner">
          ...
          <div class="row">
            <div class="col-md-4 g-mb-20 g-mb-0--md">
              ...
              <img class="img-fluid g-mb-20" src="<?php echo STATIC_URL; ?>img-temp/1000x565/img1.jpg" alt="Image description">
            ...
            <div class="col-md-4 g-mb-20 g-mb-0--md">
              ...
              <img class="img-fluid g-mb-20" src="<?php echo STATIC_URL; ?>img-temp/1000x565/img2.jpg" alt="Image description">
            ...
            <div class="col-md-4">
              ...
              <img class="img-fluid g-mb-20" src="<?php echo STATIC_URL; ?>img-temp/1000x565/img3.jpg" alt="Image description">
        ...
        <div id="carouselCus1" class="js-carousel"
          ...
          <div class="js-slide g-pt-60 g-pb-5 g-px-15">
            ...
            <div class="text-center u-shadow-v10 g-bg-white g-pa-0-35-35--sm g-pa-0-20-20">
              <img class="rounded-circle mx-auto g-width-100 g-brd-10 g-brd-around g-theme-brd-gray-light-v7 g-pull-50x-up" src="<?php echo STATIC_URL; ?>img-temp/500x500/img1.jpg" alt="Image description">
          ...
          <div class="js-slide g-pt-60 g-px-15">
            <!-- Testimonial Block -->
            <div class="text-center u-shadow-v10 g-bg-white g-pa-0-35-35--sm g-pa-0-20-20">
              <img class="rounded-circle mx-auto g-width-100 g-brd-10 g-brd-around g-theme-brd-gray-light-v7 g-pull-50x-up" src="<?php echo STATIC_URL; ?>img-temp/500x500/img2.jpg" alt="Image description">
          ...
          <div class="js-slide g-pt-60 g-px-15">
            <!-- Testimonial Block -->
            <div class="text-center u-shadow-v10 g-bg-white g-pa-0-35-35--sm g-pa-0-20-20">
              <img class="rounded-circle mx-auto g-width-100 g-brd-10 g-brd-around g-theme-brd-gray-light-v7 g-pull-50x-up" src="<?php echo STATIC_URL; ?>img-temp/500x500/img3.jpg" alt="Image description">
          ...
          <div class="js-slide g-pt-60 g-px-15">
            <!-- Testimonial Block -->
            <div class="text-center u-shadow-v10 g-bg-white g-pa-0-35-35--sm g-pa-0-20-20">
              <img class="rounded-circle mx-auto g-width-100 g-brd-10 g-brd-around g-theme-brd-gray-light-v7 g-pull-50x-up" src="<?php echo STATIC_URL; ?>img-temp/500x500/img4.jpg" alt="Image description">
          ...
          <div class="js-slide g-pt-60 g-px-15">
            <!-- Testimonial Block -->
            <div class="text-center u-shadow-v10 g-bg-white g-pa-0-35-35--sm g-pa-0-20-20">
              <img class="rounded-circle mx-auto g-width-100 g-brd-10 g-brd-around g-theme-brd-gray-light-v7 g-pull-50x-up" src="<?php echo STATIC_URL; ?>img-temp/500x500/img5.jpg" alt="Image description">
          ...
          <div class="js-slide g-pt-60 g-px-15">
            <!-- Testimonial Block -->
            <div class="text-center u-shadow-v10 g-bg-white g-pa-0-35-35--sm g-pa-0-20-20">
              <img class="rounded-circle mx-auto g-width-100 g-brd-10 g-brd-around g-theme-brd-gray-light-v7 g-pull-50x-up" src="<?php echo STATIC_URL; ?>img-temp/500x500/img6.jpg" alt="Image description">
          ...
          <div class="js-slide g-pt-60 g-px-15">
            <!-- Testimonial Block -->
            <div class="text-center u-shadow-v10 g-bg-white g-pa-0-35-35--sm g-pa-0-20-20">
              <img class="rounded-circle mx-auto g-width-100 g-brd-10 g-brd-around g-theme-brd-gray-light-v7 g-pull-50x-up" src="<?php echo STATIC_URL; ?>img-temp/500x500/img7.jpg" alt="Image description">
          ...
          <div class="js-slide g-pt-60 g-px-15">
            <!-- Testimonial Block -->
            <div class="text-center u-shadow-v10 g-bg-white g-pa-0-35-35--sm g-pa-0-20-20">
              <img class="rounded-circle mx-auto g-width-100 g-brd-10 g-brd-around g-theme-brd-gray-light-v7 g-pull-50x-up" src="<?php echo STATIC_URL; ?>img-temp/500x500/img8.jpg" alt="Image description">
      ...
      <section id="clients" class="g-bg-img-hero u-bg-overlay g-bg-primary-opacity-0_9--after g-py-80" style="background-image: url(<?php echo STATIC_URL; ?>img-temp/1920x350/img1.jpg);">
        <div class="container u-bg-overlay__inner text-center">
          <div id="carouselCus2" class="js-carousel"
            ...
            <div class="js-slide g-mx-15">
              <img class="mx-auto g-width-120" src="<?php echo STATIC_URL; ?>img-temp/clients/img1.png" alt="Image description">
            </div>

            <div class="js-slide g-mx-15">
              <img class="mx-auto g-width-120" src="<?php echo STATIC_URL; ?>img-temp/clients/img2.png" alt="Image description">
            </div>

            <div class="js-slide g-mx-15">
              <img class="mx-auto g-width-120" src="<?php echo STATIC_URL; ?>img-temp/clients/img3.png" alt="Image description">
            </div>

            <div class="js-slide g-mx-15">
              <img class="mx-auto g-width-120" src="<?php echo STATIC_URL; ?>img-temp/clients/img4.png" alt="Image description">
            </div>

            <div class="js-slide g-mx-15">
              <img class="mx-auto g-width-120" src="<?php echo STATIC_URL; ?>img-temp/clients/img5.png" alt="Image description">
            </div>

            <div class="js-slide g-mx-15">
              <img class="mx-auto g-width-120" src="<?php echo STATIC_URL; ?>img-temp/clients/img6.png" alt="Image description">
            </div>

            <div class="js-slide g-mx-15">
              <img class="mx-auto g-width-120" src="<?php echo STATIC_URL; ?>img-temp/clients/img7.png" alt="Image description">
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="gallery" class="g-pt-100">
        ...
        <div id="galleryCubePortfolio" class="cbp"
          ...
          <div class="cbp-item building">
            <a class="cbp-caption cbp-lightbox info-v3-2 d-block g-parent" href="<?php echo STATIC_URL; ?>img-temp/2800x2096/img1.jpg"
               data-title="Custom Title 1">
              <div class="cbp-caption-defaultWrap">
                <img src="<?php echo STATIC_URL; ?>img-temp/500x375/img1.jpg" alt="Image description">
              </div>
          ...
          <div class="cbp-item electricity">
            <a class="cbp-caption cbp-lightbox info-v3-2 d-block g-parent" href="<?php echo STATIC_URL; ?>img-temp/2800x2096/img2.jpg"
               data-title="Custom Title 2">
              <div class="cbp-caption-defaultWrap">
                <img src="<?php echo STATIC_URL; ?>img-temp/500x375/img2.jpg" alt="Image description">
              </div>
          ...
          <div class="cbp-item painting">
            <a class="cbp-caption cbp-lightbox info-v3-2 d-block g-parent" href="<?php echo STATIC_URL; ?>img-temp/2800x2096/img3.jpg"
               data-title="Custom Title 3">
              <div class="cbp-caption-defaultWrap">
                <img src="<?php echo STATIC_URL; ?>img-temp/500x375/img3.jpg" alt="Image description">
              </div>
          ...
          <div class="cbp-item building">
            <a class="cbp-caption cbp-lightbox info-v3-2 d-block g-parent" href="<?php echo STATIC_URL; ?>img-temp/2800x2096/img4.jpg"
               data-title="Custom Title 4">
              <div class="cbp-caption-defaultWrap">
                <img src="<?php echo STATIC_URL; ?>img-temp/500x375/img4.jpg" alt="Image description">
              </div>
          ...
          <div class="cbp-item electricity">
            <a class="cbp-caption cbp-lightbox info-v3-2 d-block g-parent" href="<?php echo STATIC_URL; ?>img-temp/2800x2096/img5.jpg"
               data-title="Custom Title 5">
              <div class="cbp-caption-defaultWrap">
                <img src="<?php echo STATIC_URL; ?>img-temp/500x375/img5.jpg" alt="Image description">
              </div>
          ...
          <div class="cbp-item painting">
            <a class="cbp-caption cbp-lightbox info-v3-2 d-block g-parent" href="<?php echo STATIC_URL; ?>img-temp/2800x2096/img6.jpg"
               data-title="Custom Title 6">
              <div class="cbp-caption-defaultWrap">
                <img src="<?php echo STATIC_URL; ?>img-temp/500x375/img6.jpg" alt="Image description">
              </div>
          ...
          <div class="cbp-item painting">
            <a class="cbp-caption cbp-lightbox info-v3-2 d-block g-parent" href="<?php echo STATIC_URL; ?>img-temp/2800x2096/img7.jpg"
               data-title="Custom Title 7">
              <div class="cbp-caption-defaultWrap">
                <img src="<?php echo STATIC_URL; ?>img-temp/500x375/img7.jpg" alt="Image description">
              </div>
          ...
          <div class="cbp-item building">
            <a class="cbp-caption cbp-lightbox info-v3-2 d-block g-parent" href="<?php echo STATIC_URL; ?>img-temp/2800x2096/img8.jpg"
               data-title="Custom Title 8">
              <div class="cbp-caption-defaultWrap">
                <img src="<?php echo STATIC_URL; ?>img-temp/500x375/img8.jpg" alt="Image description">
              </div>
          ...
          <div class="cbp-item plumbing">
            <a class="cbp-caption cbp-lightbox info-v3-2 d-block g-parent" href="<?php echo STATIC_URL; ?>img-temp/2800x2096/img9.jpg"
               data-title="Custom Title 9">
              <div class="cbp-caption-defaultWrap">
                <img src="<?php echo STATIC_URL; ?>img-temp/500x375/img9.jpg" alt="Image description">
              </div>
          ...
          <div class="cbp-item building">
            <a class="cbp-caption cbp-lightbox info-v3-2 d-block g-parent" href="<?php echo STATIC_URL; ?>img-temp/2800x2096/img10.jpg"
               data-title="Custom Title 10">
              <div class="cbp-caption-defaultWrap">
                <img src="<?php echo STATIC_URL; ?>img-temp/500x375/img10.jpg" alt="Image description">
              </div>
          ...
          <div class="cbp-item construction">
            <a class="cbp-caption cbp-lightbox info-v3-2 d-block g-parent" href="<?php echo STATIC_URL; ?>img-temp/2800x2096/img11.jpg"
               data-title="Custom Title 11">
              <div class="cbp-caption-defaultWrap">
                <img src="<?php echo STATIC_URL; ?>img-temp/500x375/img11.jpg" alt="Image description">
              </div>
          ...
          <div class="cbp-item construction">
            <a class="cbp-caption cbp-lightbox info-v3-2 d-block g-parent" href="<?php echo STATIC_URL; ?>img-temp/2800x2096/img12.jpg"
               data-title="Custom Title 12">
              <div class="cbp-caption-defaultWrap">
                <img src="<?php echo STATIC_URL; ?>img-temp/500x375/img12.jpg" alt="Image description">
              </div>
